...
| LinkedIn Jobs (jobs-listings@linkedin.com) | "Harbor Freight Tools is hiring a Sr. Business Intelligence Analyst, Supply Chain - Remote" | Received June 27 00:24 UTC. Posted 6/25/2026. JP is employed — informational only. |
...
|---------|------|---------|-------|
| EverCommerce (PaySimple) | Data Analyst Payments | 2026-05-09 | Jodi Cohen warm referral — courtesy withdrawal email optional |
...
| Mercer Advisors | Senior BI Analyst | 2026-05-16 | Power BI + Azure — still active on Greenhouse |
...
No active interviews — **HIRED at Crocs.** Prep files in `prep/` remain archived.

---

## New Leads Found

*Informational — backup pipeline only. No action needed while at Crocs.*
...
1. **Activate DailyPay account** *(6th reminder — overdue)* — Crocs's payroll service has sent 6 alerts since June 5. Activate the early wage access benefit.
2. **Remove LinkedIn "Open to Work" badge** *(4th consecutive flag)* — Recruiters continue outreaching. JP is employed. Update the profile today — 30 seconds in LinkedIn settings.
3. **Withdraw from active applications** — Zillow P749151 and P750075 still show "In Process" in Workday. Two-line withdrawal keeps the Zillow door open professionally.
4. **Close out job-tracker.csv** — Mark all "Ready to Apply" and remaining "Applied" rows as "Withdrawn — Hired at Crocs."
